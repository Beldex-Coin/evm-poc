        ...
        try:
            ...
            if msg[0]==b'info':
                ...
                if contract_address in self.evmcontext.contracts:
                    return [b"info", self.evmcontext.contracts[contract_address].amount, self.evmcontext.contracts[contract_address].contract_name]
                else:
                ...
                if len(self.requests) == 0:
                    ...
                    for contract_interaction, contract_address in self.requests:
                        ...
                        if contract_interaction.contract_type == ContractType.Create:
                            ...
                            logging.error('received contract request Name {}'.format(contract.contract_name))
            except Exception as e: 
                logging.warning(e)
...
class InfoClient(object):
    def __init__(self, address):
        ...
        asyncio.run(self.send_recv(address))
    ...
    async def send_recv(self, contract_address):
        ...
        await self.socket.send_multipart([b'info', contract_address])
